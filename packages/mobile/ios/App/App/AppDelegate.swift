...
class BridgeViewController: CAPBridgeViewController {
    ...
    override func capacitorDidLoad() {
        ...
        let source = """
        window.__ORBIT_APNS_ENV__ = '\(apnsEnvironment)';
        window.__ORBIT_HARDWARE_KEYBOARD__ = \(attached ? "true" : "false");
        """
    ...
    private func publishHardwareKeyboardState(_ attached: Bool) {
        ...
        window.__ORBIT_HARDWARE_KEYBOARD__ = \(value);
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private static let widgetAppGroup = "group.com.orbit.mobile"
    private static let widgetSnapshotKey = "widgetSnapshot"

    /// Pulls the session overview JSON from the web layer (window.__ORBIT_WIDGET_SNAPSHOT__),
    ...
    private func writeWidgetSnapshot() {
        ...
        let js = "(typeof window.__ORBIT_WIDGET_SNAPSHOT__ === 'function') ? window.__ORBIT_WIDGET_SNAPSHOT__() : null"
