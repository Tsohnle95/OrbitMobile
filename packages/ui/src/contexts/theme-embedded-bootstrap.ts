...
type ThemeBootstrapWindow = Window & {
  __orbitEmbeddedThemeBootstrap?: unknown;
};
...
export const publishEmbeddedThemeBootstrap = (theme: Theme): void => {
  ...
  (window as ThemeBootstrapWindow).__orbitEmbeddedThemeBootstrap = theme;
};
...
export const readEmbeddedThemeBootstrap = (): Theme | null => {
  ...
  try {
    ...
    return isValidTheme(parent.__orbitEmbeddedThemeBootstrap)
      ? parent.__orbitEmbeddedThemeBootstrap
      : null;
  } catch {
    return null;
  }
