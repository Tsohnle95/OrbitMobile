...
const MarkdownImageThumbnail: React.FC<{
  ...
  return (
    <button
      ...
      onClick={openPreview}
      data-orbit-markdown-image-action="true"
      data-orbit-markdown-image-source={candidate.source}
      data-orbit-markdown-image-filename={candidate.filename}
    >
      <span className="flex h-[72px] w-[100px] items-center justify-center overflow-hidden rounded-lg border border-border/40 bg-muted/10">
        {image.url && image.status !== 'error' ? (
          <img
            ...
            data-orbit-markdown-image="true"
            data-orbit-markdown-image-thumbnail="true"
            data-orbit-markdown-image-state={image.status}
          />
        ) : (
      ...
      <span
        ...
        title={candidate.filename}
        data-orbit-markdown-image-caption="true"
      >
...
export const MarkdownImageGallery: React.FC<{
  ...
  return (
    <div
      ...
      data-orbit-markdown-image-gallery="true"
    >
