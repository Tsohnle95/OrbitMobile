...
const ChatInputComponent: React.FC<ChatInputProps> = ({
    ...
    const handleDragEnter = (e: React.DragEvent) => {
        ...
        const isInternal = e.dataTransfer.types?.includes('application/x-orbit-file-path') ?? false;
    ...
    const handleDrop = async (e: React.DragEvent) => {
        ...
        const internalPath = e.dataTransfer.getData('application/x-orbit-file-path');
    ...
    const toggleDictation = React.useCallback(() => {
        window.dispatchEvent(new CustomEvent('orbit:dictation-toggle'));
    }, []);
