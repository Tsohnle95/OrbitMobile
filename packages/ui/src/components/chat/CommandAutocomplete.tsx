...
type CommandSource = 'orbit' | 'opencode' | 'skill';
      ...
      try {
        ...
        const builtInCommands: CommandInfo[] = [
          ...(hasSession && !hasMessagesInCurrentSession
            ? [{ id: 'orbit:init', name: 'init', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.initDescription'), isBuiltIn: true }]
            : []
          ),
          ...(hasSession  // Show when session exists, not when hasMessages
            ? [
                { id: 'orbit:undo', name: 'undo', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.undoDescription'), isBuiltIn: true },
                { id: 'orbit:redo', name: 'redo', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.redoDescription'), isBuiltIn: true },
                { id: 'orbit:timeline', name: 'timeline', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.timelineDescription'), isBuiltIn: true },
              ]
            : []
          ),
          { id: 'orbit:compact', name: 'compact', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.compactDescription'), isBuiltIn: true },
          ...(hasSession
            ? [{ id: 'orbit:btw', name: 'btw', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.btwDescription'), isOrbit: true }]
            : []
          ),
          ...(hasSession
            ? [{ id: 'orbit:summary', name: 'summary', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.summaryDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:workspace-review', name: 'workspace-review', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.workspaceReviewDescription'), isOrbit: true }]
            : []
          ),
          ...(canUseReviewHandoffFlow
            ? [{ id: 'orbit:handoff-review', name: 'handoff-review', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.handoffReviewDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:plan-feature', name: 'plan-feature', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.featurePlanDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:craft-goal', name: 'craft-goal', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.craftGoalDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:schedule-task', name: 'schedule-task', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.scheduleTaskDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:catch-up', name: 'catch-up', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.catchUpDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:debug', name: 'debug', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.debugDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:weigh', name: 'weigh', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.weighDescription'), isOrbit: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'orbit:explore', name: 'explore', source: 'orbit' as const, description: t('chat.commandAutocomplete.command.exploreDescription'), isOrbit: true }]
            : []
          ),
        ];
        ...
        {loading ? (
          ...
          <div>
            {commands.map((command, index) => {
              ...
              const isOrbitBadge = command.isOrbit;
              return (
