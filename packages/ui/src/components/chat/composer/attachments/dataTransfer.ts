 ...
 * payloads must be parsed for paths, and Orbit's own file tree marks an
...
/** Data type marking a drag that started in Orbit's own file tree. */
export const INTERNAL_FILE_PATH_TYPE = 'application/x-orbit-file-path';
