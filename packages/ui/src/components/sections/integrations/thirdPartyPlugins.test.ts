...
const claudePackage = '@orbit/opencode-claude';
...
describe('third-party plugin catalog helpers', () => {
  ...
  test('matches only a package or its versioned spec', () => {
    ...
    expect(specMatchesPackage('@orbit/opencode-claude-extra@0.6.0', claudePackage)).toBe(false);
  });

  test('points catalog plugins at the Orbit GitHub and npm packages', () => {
