...
/**
 * Which Orbit capabilities agents are given.
 *
 ...
 */
export const OrbitToolsSettings: React.FC = () => {
  const { t } = useI18n();
  ...
  return (
    <SettingsSection title={t('settings.orbit.tools.title')}>
      <div className={SETTINGS_OPTION_STACK_CLASS}>
        <SettingsCheckboxRow
          settingsItem="sessions.agent-control-tool"
          checked={agentControlToolEnabled}
          onChange={handleAgentControlToolChange}
          label={t('settings.orbit.tools.field.agentControlTool')}
          ariaLabel={t('settings.orbit.tools.field.agentControlToolAria')}
          info={t('settings.orbit.tools.field.agentControlToolInfo')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.orbit.tools.field.agentWebTool')}
          ariaLabel={t('settings.orbit.tools.field.agentWebToolAria')}
          info={t('settings.orbit.tools.field.agentWebToolInfo')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.orbit.tools.field.agentMemoryTool')}
          ariaLabel={t('settings.orbit.tools.field.agentMemoryToolAria')}
          info={t('settings.orbit.tools.field.agentMemoryToolInfo')}
        />
        ) : null}
      </div>
    </SettingsSection>
