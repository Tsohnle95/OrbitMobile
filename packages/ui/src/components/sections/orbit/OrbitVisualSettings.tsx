...
const THEME_MODE_OPTIONS: Array<{ value: ThemeMode; labelKey: string; descriptionKey: string }> = [
    {
        value: 'system',
        labelKey: 'settings.orbit.visual.option.themeMode.system',
        descriptionKey: 'settings.orbit.visual.option.themeMode.system.description',
    },
    {
        value: 'light',
        labelKey: 'settings.orbit.visual.option.themeMode.light',
        descriptionKey: 'settings.orbit.visual.option.themeMode.light.description',
    },
    {
        value: 'dark',
        labelKey: 'settings.orbit.visual.option.themeMode.dark',
        descriptionKey: 'settings.orbit.visual.option.themeMode.dark.description',
    },
];
...
const DIFF_LAYOUT_OPTIONS: Option<'dynamic' | 'inline' | 'side-by-side'>[] = [
    {
        id: 'dynamic',
        labelKey: 'settings.orbit.visual.option.diffLayout.dynamic.label',
        descriptionKey: 'settings.orbit.visual.option.diffLayout.dynamic.description',
    },
    {
        id: 'inline',
        labelKey: 'settings.orbit.visual.option.diffLayout.inline.label',
        descriptionKey: 'settings.orbit.visual.option.diffLayout.inline.description',
    },
    {
        id: 'side-by-side',
        labelKey: 'settings.orbit.visual.option.diffLayout.sideBySide.label',
        descriptionKey: 'settings.orbit.visual.option.diffLayout.sideBySide.description',
    },
];
...
const MERMAID_RENDERING_OPTIONS: Option<'svg' | 'ascii'>[] = [
    {
        id: 'svg',
        labelKey: 'settings.orbit.visual.option.mermaidRendering.svg.label',
        descriptionKey: 'settings.orbit.visual.option.mermaidRendering.svg.description',
    },
    {
        id: 'ascii',
        labelKey: 'settings.orbit.visual.option.mermaidRendering.ascii.label',
        descriptionKey: 'settings.orbit.visual.option.mermaidRendering.ascii.description',
    },
];

const DEFAULT_PWA_INSTALL_NAME = 'Orbit - AI Coding Assistant';
const PWA_ORIENTATION_OPTIONS: Option<'system' | 'portrait' | 'landscape'>[] = [
    {
        id: 'system',
        labelKey: 'settings.orbit.visual.option.pwaOrientation.system.label',
        descriptionKey: 'settings.orbit.visual.option.pwaOrientation.system.description',
    },
    {
        id: 'portrait',
        labelKey: 'settings.orbit.visual.option.pwaOrientation.portrait.label',
        descriptionKey: 'settings.orbit.visual.option.pwaOrientation.portrait.description',
    },
    {
        id: 'landscape',
        labelKey: 'settings.orbit.visual.option.pwaOrientation.landscape.label',
        descriptionKey: 'settings.orbit.visual.option.pwaOrientation.landscape.description',
    },
];
...
const MOBILE_KEYBOARD_MODE_OPTIONS: Option<MobileKeyboardMode>[] = [
    {
        id: 'native',
        labelKey: 'settings.orbit.visual.option.mobileKeyboardMode.native.label',
        descriptionKey: 'settings.orbit.visual.option.mobileKeyboardMode.native.description',
    },
    {
        id: 'resize-content',
        labelKey: 'settings.orbit.visual.option.mobileKeyboardMode.resizeContent.label',
        descriptionKey: 'settings.orbit.visual.option.mobileKeyboardMode.resizeContent.description',
    },
];

type PwaInstallNameWindow = Window & {
    __ORBIT_SET_PWA_INSTALL_NAME__?: (value: string) => string;
    __ORBIT_SET_PWA_ORIENTATION__?: (value: 'system' | 'portrait' | 'landscape') => 'system' | 'portrait' | 'landscape';
    __ORBIT_UPDATE_PWA_MANIFEST__?: () => void;
};
...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        labelKey: 'settings.orbit.visual.option.userMessageRendering.markdown.label',
        descriptionKey: 'settings.orbit.visual.option.userMessageRendering.markdown.description',
    },
    {
        id: 'plain',
        labelKey: 'settings.orbit.visual.option.userMessageRendering.plain.label',
        descriptionKey: 'settings.orbit.visual.option.userMessageRendering.plain.description',
    },
];
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        labelKey: 'settings.orbit.visual.option.chatRenderMode.sorted.label',
        descriptionKey: 'settings.orbit.visual.option.chatRenderMode.sorted.description',
    },
    {
        id: 'live',
        labelKey: 'settings.orbit.visual.option.chatRenderMode.live.label',
        descriptionKey: 'settings.orbit.visual.option.chatRenderMode.live.description',
    },
];
...
const MESSAGE_STREAM_TRANSPORT_OPTIONS: Option<'auto' | 'ws' | 'sse'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.orbit.visual.option.messageTransport.auto.label',
        descriptionKey: 'settings.orbit.visual.option.messageTransport.auto.description',
    },
    {
        id: 'ws',
        labelKey: 'settings.orbit.visual.option.messageTransport.ws.label',
        descriptionKey: 'settings.orbit.visual.option.messageTransport.ws.description',
    },
    {
        id: 'sse',
        labelKey: 'settings.orbit.visual.option.messageTransport.sse.label',
        descriptionKey: 'settings.orbit.visual.option.messageTransport.sse.description',
    },
];
...
const ACTIVITY_RENDER_MODE_OPTIONS: Option<'collapsed' | 'summary'>[] = [
    {
        id: 'collapsed',
        labelKey: 'settings.orbit.visual.option.activityRenderMode.collapsed.label',
        descriptionKey: 'settings.orbit.visual.option.activityRenderMode.collapsed.description',
    },
    {
        id: 'summary',
        labelKey: 'settings.orbit.visual.option.activityRenderMode.summary.label',
        descriptionKey: 'settings.orbit.visual.option.activityRenderMode.summary.description',
    },
];
...
const TIME_FORMAT_OPTIONS: Option<'auto' | '12h' | '24h'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.orbit.visual.option.timeFormat.auto.label',
        descriptionKey: 'settings.orbit.visual.option.timeFormat.auto.description',
    },
    {
        id: '24h',
        labelKey: 'settings.orbit.visual.option.timeFormat.24h.label',
        descriptionKey: 'settings.orbit.visual.option.timeFormat.24h.description',
    },
    {
        id: '12h',
        labelKey: 'settings.orbit.visual.option.timeFormat.12h.label',
        descriptionKey: 'settings.orbit.visual.option.timeFormat.12h.description',
    },
];
...
const WEEK_START_OPTIONS: Option<'auto' | 'monday' | 'sunday'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.orbit.visual.option.weekStart.auto.label',
        descriptionKey: 'settings.orbit.visual.option.weekStart.auto.description',
    },
    {
        id: 'monday',
        labelKey: 'settings.orbit.visual.option.weekStart.monday.label',
    },
    {
        id: 'sunday',
        labelKey: 'settings.orbit.visual.option.weekStart.sunday.label',
    },
];
...
const FOLLOW_UP_BEHAVIOR_OPTIONS: Option<FollowUpBehavior>[] = [
    {
        id: 'steer',
        labelKey: 'settings.orbit.visual.option.followUpBehavior.steer.label',
    },
    {
        id: 'queue',
        labelKey: 'settings.orbit.visual.option.followUpBehavior.queue.label',
    },
];
...
const WINDOW_CONTROLS_POSITION_OPTIONS: Array<{ id: DesktopWindowControlsPosition; labelKey: string }> = [
    { id: 'left', labelKey: 'settings.orbit.desktopNetwork.option.windowControlsLeft' },
    { id: 'right', labelKey: 'settings.orbit.desktopNetwork.option.windowControlsRight' },
];

const WINDOW_CONTROLS_STYLE_OPTIONS: Array<{ id: DesktopWindowControlsStyle; labelKey: string }> = [
    { id: 'classic', labelKey: 'settings.orbit.desktopNetwork.option.windowControlsClassic' },
    { id: 'traffic-lights', labelKey: 'settings.orbit.desktopNetwork.option.windowControlsTrafficLights' },
];

interface OrbitVisualSettingsProps {
    /** Which settings to show. If undefined, shows all. */
    visibleSettings?: VisibleSetting[];
}

export const OrbitVisualSettings: React.FC<OrbitVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const dockBadgeSupported = React.useMemo(
        () => isDesktopShell() && typeof window !== 'undefined'
            && (window as unknown as { __ORBIT_PLATFORM__?: string }).__ORBIT_PLATFORM__ === 'darwin',
        [],
    );
    ...
    const handleFileViewerPreviewChange = React.useCallback((enabled: boolean) => {
        ...
        window.dispatchEvent(new CustomEvent('orbit:file-viewer-preview-mode-changed', { detail: { enabled } }));
    ...
    const selectedTimeFormatLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.orbit.visual.option.timeFormat.auto.label');
    ...
    const selectedWeekStartLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.orbit.visual.option.weekStart.auto.label');
    ...
    const applyPwaInstallName = React.useCallback(async (value: string) => {
        ...
        if (typeof win.__ORBIT_SET_PWA_INSTALL_NAME__ === 'function') {
            const resolved = win.__ORBIT_SET_PWA_INSTALL_NAME__(persistedValue);
            setPwaInstallName(resolved);
            return;
        }

        setPwaInstallName(persistedValue || DEFAULT_PWA_INSTALL_NAME);
        win.__ORBIT_UPDATE_PWA_MANIFEST__?.();
    }, []);
    ...
    const applyPwaOrientation = React.useCallback(async (value: 'system' | 'portrait' | 'landscape') => {
        ...
        if (typeof win.__ORBIT_SET_PWA_ORIENTATION__ === 'function') {
            const resolved = win.__ORBIT_SET_PWA_ORIENTATION__(normalized);
    ...
    return (
        <div className="space-y-0">
                ...
                {hasAppearanceSettings && (
                    <div className="space-y-0">
                        {hasThemeSettings && (
                            <SettingsSection title={t('settings.orbit.visual.section.colorModeAndTheme')} divider={false}>
                                <SettingsTwoColumn>
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsRadioGroup aria-label={t('settings.orbit.visual.section.colorMode')}>
                                    ...
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsStackedField
                                            label={t('settings.orbit.visual.field.lightTheme')}
                                            settingsItem="appearance.light-theme"
                                        >
                                            <Select value={selectedLightTheme?.metadata.id ?? ''} onValueChange={setLightThemePreference}>
                                                <SelectTrigger aria-label={t('settings.orbit.visual.field.selectLightThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.orbit.visual.field.selectThemePlaceholder')}>
                                                        {selectedLightTheme
                                        ...
                                        <SettingsStackedField
                                            label={t('settings.orbit.visual.field.darkTheme')}
                                            settingsItem="appearance.dark-theme"
                                        >
                                            <Select value={selectedDarkTheme?.metadata.id ?? ''} onValueChange={setDarkThemePreference}>
                                                <SelectTrigger aria-label={t('settings.orbit.visual.field.selectDarkThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.orbit.visual.field.selectThemePlaceholder')}>
                                                        {selectedDarkTheme
                                        ...
                                        <div className="flex items-center gap-2 pt-1">
                                            ...
                                            >
                                                ...
                                                {themesReloading ? t('settings.orbit.visual.actions.reloadingThemes') : t('settings.orbit.visual.actions.reloadThemes')}
                                            </button>
                                            <SettingsInfoHint>
                                                {t('settings.orbit.visual.field.themeImportInfoTooltip')}
                                            </SettingsInfoHint>
                                        </div>
                                    </div>
                                </SettingsTwoColumn>
                                ...
                                {dockBadgeSupported && (
                                    <SettingsInset settingsItem="appearance.dock-badge">
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.orbit.visual.field.dockBadge')}
                                            info={t('settings.orbit.visual.field.dockBadgeHint')}
                                            ariaLabel={t('settings.orbit.visual.field.dockBadge')}
                                        />
                                    </SettingsInset>
                                )}
                            </SettingsSection>
                        ...
                        {showWindowControlsPositionSetting && (
                            <SettingsSection
                                title={t('settings.orbit.desktopNetwork.field.windowControls')}
                                info={t('settings.orbit.desktopNetwork.field.windowControlsPositionDescription')}
                                divider={hasThemeSettings}
                            >
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                        label={t('settings.orbit.desktopNetwork.field.windowControlsPosition')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.orbit.desktopNetwork.field.windowControlsPositionAria')}
                                        />
                                    </SettingsStackedField>
                                    <SettingsStackedField
                                        label={t('settings.orbit.desktopNetwork.field.windowControlsStyle')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.orbit.desktopNetwork.field.windowControlsStyleAria')}
                                        />
                                    </SettingsStackedField>
                                </SettingsTwoColumn>
                            </SettingsSection>
                        ...
                        {hasLocalizationSettings && (
                            <SettingsSection title={t('settings.orbit.visual.section.localization')}>
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                    ...
                                    {(shouldShow('timeFormat') || shouldShow('weekStart')) && (
                                        <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                            {shouldShow('timeFormat') && (
                                                <SettingsStackedField
                                                    label={t('settings.orbit.visual.field.timeFormat')}
                                                ...
                                                >
                                                    <Select value={timeFormatPreference} onValueChange={(value: 'auto' | '12h' | '24h') => handleTimeFormatPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.orbit.visual.field.selectTimeFormatAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            ...
                                            {shouldShow('weekStart') && (
                                                <SettingsStackedField
                                                    label={t('settings.orbit.visual.field.weekStartsOn')}
                                                ...
                                                >
                                                    <Select value={weekStartPreference} onValueChange={(value: 'auto' | 'monday' | 'sunday') => handleWeekStartPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.orbit.visual.field.selectWeekStartAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            <SettingsSection title={t('settings.orbit.visual.section.appInstall')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>

                            {showPwaInstallNameSetting && (
                                <SettingsFieldRow
                                    label={t('settings.orbit.visual.field.installAppName')}
                                    info={t('settings.orbit.visual.field.installAppNameHint')}
                                ...
                                >
                                    <Input
                                        ...
                                        maxLength={64}
                                        aria-label={t('settings.orbit.visual.field.pwaInstallAppNameAria')}
                                    />
                                    <Button size="sm"
                                        type="button"
                                        variant="ghost"
                                        ...
                                        aria-label={t('settings.orbit.visual.actions.resetInstallAppNameAria')}
                            ...
                            {showPwaOrientationSetting && (
                                <SettingsFieldRow
                                    label={t('settings.orbit.visual.field.installOrientation')}
                                    description={t('settings.orbit.visual.field.installOrientationHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.orbit.visual.field.pwaInstallOrientationAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.orbit.visual.field.selectOrientationPlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.orbit.visual.actions.resetInstallOrientationAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                            ...
                            {showMobileKeyboardModeSetting && (
                                <SettingsFieldRow
                                    label={t('settings.orbit.visual.field.mobileKeyboardMode')}
                                    info={t('settings.orbit.visual.field.mobileKeyboardModeHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.orbit.visual.field.mobileKeyboardModeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.orbit.visual.field.selectMobileKeyboardModePlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.orbit.visual.actions.resetMobileKeyboardModeAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                ...
                {/* --- Density & type --- */}
                {hasLayoutSettings && (
                    <SettingsSection title={t('settings.orbit.visual.section.densityAndType')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.orbit.visual.field.interfaceFont')}
                                        settingsItem="appearance.interface-font-size"
                                        controlClassName="w-full"
                                    >
                                        <Select value={uiFont} onValueChange={(value) => setUiFont(value as UiFontOption)}>
                                            <SelectTrigger aria-label={t('settings.orbit.visual.field.selectInterfaceFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.orbit.visual.actions.resetInterfaceFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.orbit.visual.field.codeFont')}
                                        controlClassName="w-full"
                                    >
                                        <Select value={monoFont} onValueChange={(value) => setMonoFont(value as MonoFontOption)}>
                                            <SelectTrigger aria-label={t('settings.orbit.visual.field.selectCodeFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.orbit.visual.actions.resetCodeFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                        ...
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') || shouldShow('editorFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.orbit.visual.field.interfaceFontSize')}
                                        controlClassName="w-full"
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            <NumberInput
                                                ...
                                                max={200}
                                                step={5}
                                                aria-label={t('settings.orbit.visual.field.fontSizePercentageAria')}
                                            />
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.orbit.visual.actions.resetFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.orbit.visual.field.terminalFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.orbit.visual.actions.resetTerminalFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('editorFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.orbit.visual.field.editorFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.orbit.visual.actions.resetEditorFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                        ...
                        {shouldShow('spacing') || (shouldShow('inputBarOffset') && isMobile) ? (
                            <SettingsTwoColumn>
                                {shouldShow('spacing') && (
                                    <SettingsStackedField
                                        label={t('settings.orbit.visual.field.spacingDensity')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.orbit.visual.actions.resetSpacingAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('inputBarOffset') && isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.orbit.visual.field.inputBarOffset')}
                                        info={t('settings.orbit.visual.field.inputBarOffsetTooltip')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.orbit.visual.actions.resetInputBarOffsetAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                ...
                {hasNavigationSettings && (
                    <SettingsSection title={t('settings.orbit.visual.section.navigation')} contentClassName="space-y-4">
                        {shouldShow('fileEditorKeymap') && (
                            <SettingsControlGroup
                                title={t('settings.orbit.visual.field.fileEditorKeymap')}
                                settingsItem="appearance.file-editor-keymap"
                            >
                                <SettingsRadioGroup aria-label={t('settings.orbit.visual.field.fileEditorKeymap')}>
                                    {(['default', 'vim'] as const).map((keymap) => (
                                        <SettingsRadioOption
                                            key={keymap}
                                            selected={fileEditorKeymap === keymap}
                                            onSelect={() => setFileEditorKeymap(keymap)}
                                            label={t(`settings.orbit.visual.option.fileEditorKeymap.${keymap}`)}
                                            ariaLabel={t(`settings.orbit.visual.option.fileEditorKeymap.${keymap}`)}
                                        />
                                    ))}
                                </SettingsRadioGroup>
                            </SettingsControlGroup>
                        ...
                        <div className={SETTINGS_OPTION_STACK_CLASS}>
                            {shouldShow('autoSaveEnabled') && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.orbit.visual.field.autoSaveEnabled')}
                                    ariaLabel={t('settings.orbit.visual.field.autoSaveEnabledAria')}
                                    info={t('settings.orbit.visual.field.autoSaveEnabledInfo')}
                                    settingsItem="appearance.auto-save-enabled"
                                />
                            )}
                            {showTerminalShellSetting && (
                                <SettingsStackedField
                                    label={t('settings.orbit.visual.field.terminalShell')}
                                    info={t('settings.orbit.visual.field.terminalShellHint')}
                                ...
                                >
                                    <Select value={terminalShell} onValueChange={(value) => { if (isTerminalShell(value)) setTerminalShell(value); }}>
                                        <SelectTrigger aria-label={t('settings.orbit.visual.field.terminalShellAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="auto">{t('settings.orbit.visual.option.terminalShell.auto')}</SelectItem>
                            ...
                            {showTerminalShellSetting && terminalShellSupportsLogin && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.orbit.visual.field.terminalLoginShell')}
                                    ariaLabel={t('settings.orbit.visual.field.terminalLoginShell')}
                            ...
                            {shouldShow('terminalQuickKeys') && !isMobile && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.orbit.visual.field.terminalQuickKeys')}
                                    ariaLabel={t('settings.orbit.visual.field.terminalQuickKeysAria')}
                                    settingsItem="appearance.terminal-quick-keys"
                                    info={t('settings.orbit.visual.field.terminalQuickKeysTooltip')}
                                />
                            )}
                        </div>
                        {shouldShow('sessionTabs') && !isVSCode && !isMobile && (
                            <SettingsControlGroup
                                title={t('settings.orbit.visual.field.sessionTabsGroup')}
                                settingsItem="appearance.session-tabs"
                            >
                                <SettingsCheckboxRow
                                    checked={sessionTabsEnabled}
                                    onChange={setSessionTabsEnabled}
                                    label={t('settings.orbit.visual.field.sessionTabs')}
                                    ariaLabel={t('settings.orbit.visual.field.sessionTabsAria')}
                                    info={t('settings.orbit.visual.field.sessionTabsInfo')}
                                />
                            </SettingsControlGroup>
                        )}
                    </SettingsSection>
                ...
                {hasBehaviorSettings && (
                    <>
                        {showBehaviorDisplaySettings && (
                            <SettingsSection
                                title={t('settings.orbit.visual.section.chatDisplay')}
                                divider={behaviorSectionDivider}
                                contentClassName="space-y-6"
                            >
                                {shouldShow('chatRenderMode') && (
                                    <SettingsControlGroup
                                        title={t('settings.orbit.visual.section.chatRenderMode')}
                                        settingsItem="chat.render-mode"
                                    >
                                        <div role="radiogroup" aria-label={t('settings.orbit.visual.section.chatRenderModeAria')} className="grid w-full max-w-[26rem] grid-cols-1 gap-3 @xl:grid-cols-2">
                                ...
                                {shouldShow('activityRenderMode') && chatRenderMode === 'sorted' && (
                                    <SettingsControlGroup title={t('settings.orbit.visual.section.activityDefault')}>
                                        <SettingsRadioGroup aria-label={t('settings.orbit.visual.section.activityDefaultAria')}>
                                            {ACTIVITY_RENDER_MODE_OPTIONS.map((option) => (
                                                <SettingsRadioOption
                                                    ...
                                                    label={tUnsafe(option.labelKey)}
                                                    ariaLabel={t('settings.orbit.visual.field.activityDefaultModeAria', { option: tUnsafe(option.labelKey) })}
                                                />
                                            ))}
                                        </SettingsRadioGroup>
                                    </SettingsControlGroup>
                        ...
                        {showTransportSection && (
                            <SettingsSection
                                title={t('settings.orbit.visual.section.messageStreamTransport')}
                            ...
                            >
                                <SettingsChipGroup
                                    ...
                                    aria-label={t('settings.orbit.visual.section.messageStreamTransport')}
                                />
                                {(() => {
                        ...
                        {showBehaviorMessageOptions && (
                            <SettingsSection
                                title={t('settings.orbit.visual.section.chatMessageOptions')}
                            ...
                            >
                                ...
                                <SettingsTwoColumn className="lg:gap-y-6">
                                    {shouldShow('userMessageRendering') && (
                                        <SettingsControlGroup title={t('settings.orbit.visual.section.userMessageRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.orbit.visual.section.userMessageRenderingAria')}>
                                                {USER_MESSAGE_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.orbit.visual.field.userMessageRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <SettingsControlGroup title={t('settings.orbit.visual.section.mermaidRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.orbit.visual.section.mermaidRenderingAria')}>
                                                {MERMAID_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.orbit.visual.field.mermaidRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <SettingsControlGroup title={t('settings.orbit.visual.section.diffLayout')}>
                                            <SettingsRadioGroup aria-label={t('settings.orbit.visual.section.diffLayoutAria')}>
                                                {DIFF_LAYOUT_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.orbit.visual.field.diffLayoutAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('followUpBehavior') && (
                                        <SettingsControlGroup
                                            title={t('settings.orbit.visual.section.followUpBehavior')}
                                            settingsItem="chat.follow-up-behavior"
                                        >
                                            <SettingsRadioGroup aria-label={t('settings.orbit.visual.section.followUpBehaviorAria')}>
                                                {FOLLOW_UP_BEHAVIOR_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.orbit.visual.field.followUpBehaviorAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                        ...
                        {showBehaviorFeatureCheckboxes && (
                            <>
                                {shouldShow('expandedTools') && (
                                    <SettingsSection
                                        title={t('settings.orbit.visual.section.showToolsOpenedByDefault')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.orbit.visual.field.bash')}
                                            ariaLabel={t('settings.orbit.visual.field.showExpandedBashToolsAria')}
                                        />
                                        <SettingsCheckboxRow
                                            checked={showExpandedEditTools}
                                            onChange={handleShowExpandedEditToolsChange}
                                            label={t('settings.orbit.visual.field.editTools')}
                                            ariaLabel={t('settings.orbit.visual.field.showExpandedEditToolsAria')}
                                        />
                                    </SettingsSection>
                                )}
                                <SettingsSection
                                    title={t('settings.orbit.visual.section.sessionAssistance')}
                                ...
                                >
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.draftStartersVisible')}
                                        ariaLabel={t('settings.orbit.visual.field.draftStartersVisibleAria')}
                                    ...
                                    />
                                        {shouldShow('sessionAssist') && (
                                            <>
                                                <SettingsCheckboxRow
                                                    ...
                                                    label={t('settings.orbit.visual.field.sessionRecap')}
                                                    ariaLabel={t('settings.orbit.visual.field.sessionRecapAria')}
                                                    settingsItem="chat.session-recap"
                                                />
                                                <SettingsCheckboxRow
                                                    checked={sessionSuggestionEnabled}
                                                    onChange={setSessionSuggestionEnabled}
                                                    label={t('settings.orbit.visual.field.sessionSuggestion')}
                                                    ariaLabel={t('settings.orbit.visual.field.sessionSuggestionAria')}
                                        ...
                                        {shouldShow('subagentReadOnlyBanner') && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.orbit.visual.field.allowPromptingSubagentSessions')}
                                                ariaLabel={t('settings.orbit.visual.field.allowPromptingSubagentSessionsAria')}
                                ...
                                {shouldShow('sessionGoal') && !isVSCode && (
                                    <SettingsSection
                                        title={t('settings.orbit.visual.goal.sectionTitle')}
                                        info={t('settings.orbit.visual.goal.description')}
                                        contentClassName={SETTINGS_OPTION_STACK_CLASS}
                                    >
                                        <SettingsCheckboxRow
                                            checked={sessionGoalEnabled}
                                            onChange={setSessionGoalEnabled}
                                            label={t('settings.orbit.visual.field.sessionGoal')}
                                            ariaLabel={t('settings.orbit.visual.field.sessionGoalAria')}
                                        ...
                                        <div data-settings-item="chat.session-goal-budget" className="flex items-center gap-2">
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.orbit.visual.goal.budgetLabel')}
                                                ariaLabel={t('settings.orbit.visual.goal.budgetAria')}
                                            />
                                ...
                                {shouldShow('reasoning') && (
                                    <SettingsSection
                                        title={t('settings.orbit.visual.section.reasoning')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.orbit.visual.field.showReasoningTraces')}
                                            ariaLabel={t('settings.orbit.visual.field.showReasoningTracesAria')}
                                        ...
                                        {showReasoningTraces && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.orbit.visual.field.collapsibleThinkingBlocks')}
                                                ariaLabel={t('settings.orbit.visual.field.collapsibleThinkingBlocksAria')}
                                            />
                                        )}
                                    </SettingsSection>
                                )}
                                ...
                                <SettingsSection
                                    title={t('settings.orbit.visual.section.messageAppearance')}
                                ...
                                {shouldShow('collapsibleUserMessages') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.collapsibleUserMessages')}
                                        ariaLabel={t('settings.orbit.visual.field.collapsibleUserMessagesAria')}
                                ...
                                {shouldShow('stickyUserHeader') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.stickyUserHeader')}
                                        ariaLabel={t('settings.orbit.visual.field.stickyUserHeaderAria')}
                                ...
                                {shouldShow('promptNavigatorEnabled') && !isVSCode && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.promptNavigatorEnabled')}
                                        ariaLabel={t('settings.orbit.visual.field.promptNavigatorEnabledAria')}
                                ...
                                {shouldShow('wideChatLayout') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.wideChatLayout')}
                                        ariaLabel={t('settings.orbit.visual.field.wideChatLayoutAria')}
                                ...
                                {shouldShow('splitAssistantMessageActions') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.showSplitAssistantMessageActions')}
                                        ariaLabel={t('settings.orbit.visual.field.showSplitAssistantMessageActionsAria')}
                                        settingsItem="chat.inline-assistant-actions"
                                        info={t('settings.orbit.visual.field.showSplitAssistantMessageActionsTooltip')}
                                    />
                                )}
                                ...
                                {shouldShow('codeBlockLineWrap') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.codeBlockLineWrap')}
                                        ariaLabel={t('settings.orbit.visual.field.codeBlockLineWrapAria')}
                                ...
                                <SettingsSection
                                    title={t('settings.orbit.visual.section.toolsAndFiles')}
                                ...
                                {shouldShow('showToolFileIcons') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.showToolFileIcons')}
                                        ariaLabel={t('settings.orbit.visual.field.showToolFileIconsAria')}
                                ...
                                {shouldShow('showTurnChangedFiles') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.showTurnChangedFiles')}
                                        ariaLabel={t('settings.orbit.visual.field.showTurnChangedFilesAria')}
                                ...
                                {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.showDotfiles')}
                                        ariaLabel={t('settings.orbit.visual.field.showDotfilesAria')}
                                ...
                                {shouldShow('fileViewerPreview') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.defaults.field.openFilesPreview')}
                                        ariaLabel={t('settings.orbit.defaults.field.openFilesPreviewAria')}
                                    />
                                )}
                                </SettingsSection>
                                )}
                                ...
                                <SettingsSection
                                    title={t('settings.orbit.visual.section.composer')}
                                ...
                                {shouldShow('persistDraft') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.persistDraftMessages')}
                                        ariaLabel={t('settings.orbit.visual.field.persistDraftMessagesAria')}
                                ...
                                {!isMobile && shouldShow('inputSpellcheck') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.orbit.visual.field.enableSpellcheckInTextInputs')}
                                        ariaLabel={t('settings.orbit.visual.field.enableSpellcheckInTextInputsAria')}
                ...
                {shouldShow('reportUsage') && (
                    <SettingsSection title={t('settings.orbit.visual.section.privacy')}>
                        <SettingsCheckboxRow
                            checked={reportUsage}
                            onChange={handleReportUsageChange}
                            label={t('settings.orbit.visual.field.sendAnonymousUsageReports')}
                            info={t('settings.orbit.visual.field.sendAnonymousUsageReportsHint')}
                            ariaLabel={t('settings.orbit.visual.field.sendAnonymousUsageReportsAria')}
