...
export const ComposerDictation: React.FC<ComposerDictationProps> = ({
    ...
    // The dictation server (WebSocket + STT worker) lives in the Orbit
    ...
    React.useEffect(() => {
        ...
        window.addEventListener('orbit:dictation-toggle', onToggle);
        return () => window.removeEventListener('orbit:dictation-toggle', onToggle);
