...
export const EMBEDDED_RUNTIME_BOOTSTRAP_REQUEST = 'orbit:embedded-runtime-bootstrap-request';
export const EMBEDDED_RUNTIME_BOOTSTRAP_RESPONSE = 'orbit:embedded-runtime-bootstrap-response';
export const EMBEDDED_VISIBILITY_REQUEST = 'orbit:embedded-visibility-request';
export const EMBEDDED_VISIBILITY_UPDATE = 'orbit:embedded-visibility';
