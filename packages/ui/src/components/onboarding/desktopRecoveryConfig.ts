  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running Orbit. Verify the address points to an Orbit server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The Orbit server at "${host || 'unknown'}" is not compatible with this app version. Update Orbit on the server, then try again.`,
