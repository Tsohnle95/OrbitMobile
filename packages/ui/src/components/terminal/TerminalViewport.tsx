...
// mounts (see the `__orbitEnsureNerdFonts` hook in index.html). Wait for
...
const ensureNerdFonts = (): Promise<void> => {
  ...
  const loader = (window as typeof window & { __orbitEnsureNerdFonts?: () => Promise<void> }).__orbitEnsureNerdFonts;
