...
const MENU_ACTION_EVENT = 'orbit:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'orbit:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('orbit:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('orbit:check-for-updates', () => {
