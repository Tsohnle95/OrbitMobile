...
describe('path-utils', () => {
  test('normalizes Windows paths without losing drive roots', () => {
    expect(normalizeFilePath('C:\\Users\\Bohdan Triapitsyn\\projects\\orbit\\')).toBe('C:/Users/Bohdan Triapitsyn/projects/orbit');
  ...
  test('does not prefix Windows absolute targets with the workspace directory', () => {
    expect(toAbsoluteFilePath('C:/Users/Bohdan Triapitsyn/projects/orbit', 'C:/Users/Bohdan Triapitsyn/projects/orbit/packages/ui/Button.tsx')).toBe(
      'C:/Users/Bohdan Triapitsyn/projects/orbit/packages/ui/Button.tsx',
    );
  });

  test('joins relative targets under Windows workspaces', () => {
    expect(toAbsoluteFilePath('C:/Users/Bohdan Triapitsyn/projects/orbit', 'packages/ui/Button.tsx')).toBe(
      'C:/Users/Bohdan Triapitsyn/projects/orbit/packages/ui/Button.tsx',
    );
    expect(toAbsoluteFilePath('C:/Users/Bohdan Triapitsyn/projects/orbit/packages/ui', '../web/package.json')).toBe(
      'C:/Users/Bohdan Triapitsyn/projects/orbit/packages/web/package.json',
    );
  });
  ...
  test('compares Windows workspace containment case-insensitively', () => {
    expect(isFilePathWithinDirectory(
      'c:/users/bohdan triapitsyn/projects/orbit/packages/ui/button.tsx',
      'C:/Users/Bohdan Triapitsyn/projects/orbit',
    )).toBe(true);
  ...
  test('falls back to file parent when current directory does not contain the path', () => {
    expect(getDirectoryForFilePath(
      ...
      'C:/Users/Bohdan Triapitsyn/projects/orbit/packages/ui/Button.tsx',
    )).toBe('C:/Users/Bohdan Triapitsyn/projects/orbit/packages/ui');
