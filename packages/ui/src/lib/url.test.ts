...
describe('isAppLinkUrl', () => {
  ...
  test('rejects Orbit and Capacitor self-deep-links', () => {
    expect(isAppLinkUrl('orbit://connect?host=x')).toBe(false);
    expect(isAppLinkUrl('orbit-ui://app/index.html')).toBe(false);
