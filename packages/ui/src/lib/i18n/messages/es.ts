...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.connect.welcome.title": "Conéctate a Orbit",
  ...
  "mobile.connect.password.placeholder": "Contraseña de Orbit",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de Orbit.",
  ...
  "mobile.connect.relay.badge": "a través de Orbit Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de Orbit.",
  ...
  "sessions.sidebar.footer.actions.aboutOrbit": "Acerca de Orbit",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de Orbit al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está Orbit y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja Orbit. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Orbit: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en Orbit. Descárgalo para abrirlo con otra aplicación.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Orbit necesita acceso a esta carpeta.",
  ...
  "aboutDialog.orbitVersionLabel": "Versión de Orbit {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Orbit, el estado de OpenCode, directorios y proyectos.",
  "aboutDialog.footerNote": "Hecho con amor para la comunidad",
  "aboutDialog.attribution": "Basado en OpenChamber (MIT) de Bohdan Triapitsyn.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Orbit de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Orbit",
  "header.actions.openAppMenuAria": "Abrir menú de Orbit",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres Orbit desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Orbit",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Orbit",
  ...
  "multiRun.window.description": "Ventana de Orbit Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a Orbit",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Orbit no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de Orbit. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Orbit y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Orbit para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Orbit o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Orbit. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Orbit pero no es compatible con esta versión de la app. Actualiza Orbit en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Orbit. Verifica que la dirección apunte a un servidor Orbit.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Orbit. Verifica que la dirección apunte a un servidor Orbit.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Orbit en \"{host}\" no es compatible con esta versión de la app. Actualiza Orbit en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "Orbit no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Orbit...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: orbit update",
  "mobileUpdate.toast.available.title": "Actualización de Orbit disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén Orbit abierto.",
  ...
  "orbitLogo.aria.logo": "Logo de Orbit",
