...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOrbit': 'À propos de Orbit',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur Orbit auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans Orbit. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Orbit doit accéder à ce dossier.',
  ...
  'aboutDialog.orbitVersionLabel': 'Version Orbit {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état Orbit, l’état de santé OpenCode, les répertoires et les projets.',
  'aboutDialog.footerNote': 'Fabriqué avec amour pour la communauté',
  'aboutDialog.attribution': 'Basé sur OpenChamber (MIT) par Bohdan Triapitsyn.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans Orbit',
  ...
  'header.actions.openAppMenu': 'Menu de Orbit',
  'header.actions.openAppMenuAria': 'Ouvrir le menu Orbit',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez Orbit depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez Orbit',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs Orbit locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution Orbit.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur Orbit',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si Orbit ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de Orbit — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres Orbit et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur Orbit auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur Orbit ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas Orbit. Vérifiez que l\'adresse pointe vers un serveur Orbit.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas Orbit. Vérifiez que l\'adresse pointe vers un serveur Orbit.',
  ...
  'startup.initRecovery.description': 'Orbit n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de Orbit...',
  ...
  'updateDialog.error.takingLonger': 'La mise à jour prend plus de temps que prévu. Attendez un peu et actualisez, ou exécutez : orbit update',
  'mobileUpdate.toast.available.title': 'Mise à jour Orbit disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez Orbit ouvert.',
  ...
  'mobile.connect.welcome.title': 'Se connecter à Orbit',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe Orbit',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion Orbit.',
  ...
  'mobile.connect.relay.badge': 'via Orbit Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur Orbit.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve Orbit, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge Orbit. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à Orbit — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’Orbit. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute Orbit mais n’est pas compatible avec cette version de l’application. Mettez Orbit à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur Orbit à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez Orbit à jour sur le serveur, puis réessayez.',
