...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o Orbit para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Orbit instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao Orbit",
  ...
  "mobile.connect.password.placeholder": "Senha do Orbit",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Orbit.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Orbit.",
  ...
  "sessions.sidebar.footer.actions.aboutOrbit": "Sobre o Orbit",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor Orbit ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o Orbit está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o Orbit. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Orbit — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no Orbit. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Orbit precisa acessar esta pasta.",
  ...
  "aboutDialog.orbitVersionLabel": "Versão do Orbit {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Orbit, a integridade do OpenCode, diretórios e projetos.",
  "aboutDialog.footerNote": "Feito com carinho para a comunidade",
  "aboutDialog.attribution": "Baseado no OpenChamber (MIT), por Bohdan Triapitsyn.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Orbit com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Orbit",
  "header.actions.openAppMenuAria": "Abrir menu do Orbit",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o Orbit de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Orbit",
  ...
  "multiRun.window.description": "Janela do Orbit Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Orbit",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Orbit não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do Orbit. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Orbit e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Orbit para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Orbit ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Orbit. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Orbit, mas não é compatível com esta versão do app. Atualize o Orbit no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Orbit. Verifique se o endereço aponta para um servidor Orbit.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Orbit. Verifique se o endereço aponta para um servidor Orbit.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Orbit em \"{host}\" não é compatível com esta versão do app. Atualize o Orbit no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Orbit não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Orbit...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: orbit update",
  "mobileUpdate.toast.available.title": "Atualização do Orbit disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o Orbit aberto.",
  ...
  "orbitLogo.aria.logo": "Logo do Orbit",
