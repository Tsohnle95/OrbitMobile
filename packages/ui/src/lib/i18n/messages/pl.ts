...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Orbit, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Orbit został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z Orbit',
  ...
  'mobile.connect.password.placeholder': 'Hasło Orbit',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia Orbit.',
  ...
  'mobile.connect.relay.badge': 'przez Orbit Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem Orbit.',
  ...
  'sessions.sidebar.footer.actions.aboutOrbit': 'O Orbit',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Orbit.',
  ...
  'onboarding.chooser.title': 'Witaj w Orbit',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Orbit nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Orbit i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Orbit aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Orbit, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Orbit. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Orbit, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Orbit na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Orbit. Zweryfikuj czy adres wskazuje na serwer Orbit.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Orbit. Zweryfikuj czy adres wskazuje na serwer Orbit.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Orbit pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Orbit na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Orbit nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Orbit, kondycję OpenCode, katalogi i projekty.',
  'aboutDialog.footerNote': 'Stworzone z sercem dla społeczności',
  'aboutDialog.attribution': 'Na podstawie OpenChamber (MIT) autorstwa Bohdana Triapitsyna.',
  ...
  'aboutDialog.orbitVersionLabel': 'Wersja Orbit {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer Orbit, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest Orbit, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest Orbit. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Orbit — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Orbit',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Orbit potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w Orbit. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu Orbit',
  'header.actions.openAppMenuAria': 'Otwórz menu Orbit',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Orbit.',
  ...
  'orbitLogo.aria.logo': 'Logo Orbit',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz Orbit z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Orbit',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: orbit update',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja Orbit',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Orbit...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Orbit otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce Orbit — zainstaluj je, aby zacząć.',
  ...
  'settings.orbit.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.orbit.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.orbit.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.orbit.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.orbit.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.orbit.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.orbit.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.orbit.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
