...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.welcome.title': '連線至 Orbit',
  ...
  'mobile.connect.password.placeholder': 'Orbit 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Orbit 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 Orbit Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Orbit 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Orbit。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Orbit，但與此應用程式版本不相容。請更新伺服器上的 Orbit 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Orbit 伺服器與此應用程式版本不相容。請更新伺服器上的 Orbit 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOrbit': '關於 Orbit',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 Orbit 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 Orbit 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 Orbit 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Orbit 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 Orbit 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Orbit 需要存取此資料夾。',
  ...
  'aboutDialog.orbitVersionLabel': 'Orbit 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Orbit 狀態、OpenCode 健康資訊、目錄和專案。',
  'aboutDialog.footerNote': '為社群用心打造',
  'aboutDialog.attribution': '基於 OpenChamber（MIT，Bohdan Triapitsyn 著）。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Orbit',
  ...
  'header.actions.openAppMenu': 'Orbit 選單',
  'header.actions.openAppMenuAria': '開啟 Orbit 選單',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 Orbit，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Orbit',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Orbit 伺服器之間切換',
  ...
  'multiRun.window.description': 'Orbit 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Orbit',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Orbit 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 Orbit 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Orbit 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Orbit 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Orbit 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Orbit。請確認位址是否指向 Orbit 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Orbit。請確認位址是否指向 Orbit 伺服器。',
  ...
  'startup.initRecovery.description': 'Orbit 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Orbit...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：orbit update',
  'mobileUpdate.toast.available.title': 'Orbit 更新可用',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Orbit 開啟。',
