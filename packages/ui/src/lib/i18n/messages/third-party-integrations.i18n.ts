...
export const thirdPartyIntegrationI18n = {
  en: {
    ...
    'settings.page.integrations.description': 'Add third-party subscriptions to use as Orbit providers.',
    ...
    'settings.integrations.thirdParty.info': 'Install a provider plugin, then set up your subscription so Orbit can use it.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor’s generous in-house model limits, now in Orbit.',
  },
  de: {
    'settings.page.integrations.title': 'Integrationen',
    'settings.page.integrations.description': 'Füge Drittanbieter-Abonnements hinzu, um sie als Orbit-Provider zu nutzen.',
    ...
    'settings.integrations.thirdParty.info': 'Installiere ein Provider-Plugin und richte dein Abonnement ein, damit Orbit es nutzen kann.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Die großzügigen Limits der Cursor-eigenen Modelle jetzt in Orbit.',
  },
  fr: {
    'settings.page.integrations.title': 'Intégrations',
    'settings.page.integrations.description': 'Ajoutez des abonnements tiers à utiliser comme fournisseurs Orbit.',
    ...
    'settings.integrations.thirdParty.info': 'Installez un plugin de fournisseur, puis configurez votre abonnement pour qu’Orbit puisse l’utiliser.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Les généreuses limites des modèles internes Cursor, désormais dans Orbit.',
  },
  es: {
    'settings.page.integrations.title': 'Integraciones',
    'settings.page.integrations.description': 'Añade suscripciones de terceros para usarlas como proveedores de Orbit.',
    ...
    'settings.integrations.thirdParty.info': 'Instala un plugin de proveedor y configura tu suscripción para que Orbit pueda usarla.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Los generosos límites de los modelos internos de Cursor, ahora en Orbit.',
  },
  ja: {
    'settings.page.integrations.title': '連携',
    'settings.page.integrations.description': 'サードパーティのサブスクリプションを追加して、Orbit のプロバイダーとして使います。',
    ...
    'settings.integrations.thirdParty.info': 'プロバイダープラグインをインストールし、サブスクリプションを設定して Orbit で使えるようにします。',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内蔵モデルの余裕ある制限が、Orbit で使えます。',
  },
  ko: {
    'settings.page.integrations.title': '통합',
    'settings.page.integrations.description': '타사 구독을 추가해 Orbit 프로바이더로 사용하세요.',
    ...
    'settings.integrations.thirdParty.info': '프로바이더 플러그인을 설치한 뒤 구독을 설정하면 Orbit에서 사용할 수 있습니다.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 자체 모델의 넉넉한 한도를 이제 Orbit에서.',
  },
  pl: {
    'settings.page.integrations.title': 'Integracje',
    'settings.page.integrations.description': 'Dodaj subskrypcje zewnętrzne, aby używać ich jako dostawców Orbit.',
    ...
    'settings.integrations.thirdParty.info': 'Zainstaluj wtyczkę dostawcy, a następnie skonfiguruj subskrypcję, aby Orbit mógł z niej korzystać.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Hojne limity wewnętrznych modeli Cursor teraz w Orbit.',
  },
  'pt-BR': {
    'settings.page.integrations.title': 'Integrações',
    'settings.page.integrations.description': 'Adicione assinaturas de terceiros para usar como provedores do Orbit.',
    ...
    'settings.integrations.thirdParty.info': 'Instale um plugin de provedor e configure sua assinatura para o Orbit poder usá-la.',
    'settings.integrations.thirdParty.actions.install': 'Instalar',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Os limites generosos dos modelos internos do Cursor, agora no Orbit.',
  },
  uk: {
    'settings.page.integrations.title': 'Інтеграції',
    'settings.page.integrations.description': 'Додайте сторонні підписки, щоб використовувати їх як провайдери Orbit.',
    ...
    'settings.integrations.thirdParty.info': 'Установіть плагін провайдера, а потім налаштуйте підписку, щоб Orbit міг її використовувати.',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Щедрі ліміти внутрішніх моделей Cursor — тепер в Orbit.',
  },
  'zh-CN': {
    'settings.page.integrations.title': '集成',
    'settings.page.integrations.description': '添加第三方订阅，将其用作 Orbit 提供商。',
    ...
    'settings.integrations.thirdParty.info': '安装提供商插件并设置订阅，以便 Orbit 可以使用它。',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内部模型的充足额度，现已可用于 Orbit。',
  },
  'zh-TW': {
    'settings.page.integrations.title': '整合',
    'settings.page.integrations.description': '新增第三方訂閱，將其用作 Orbit 供應商。',
    ...
    'settings.integrations.thirdParty.info': '安裝供應商外掛並設定訂閱，以便 Orbit 可以使用它。',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 內部模型的充足額度，現已可用於 Orbit。',
  },
} as const;
