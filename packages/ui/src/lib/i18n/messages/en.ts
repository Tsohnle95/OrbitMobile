...
export const dict = {
  ...
  'mobile.connect.welcome.title': 'Connect to Orbit',
  ...
  'mobile.connect.password.placeholder': 'Orbit password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Orbit connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Orbit server.',
  ...
  'sessions.sidebar.footer.actions.aboutOrbit': 'About Orbit',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The Orbit server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine Orbit is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting Orbit. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Orbit — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in Orbit. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Orbit needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Orbit state, OpenCode health, directories, and projects.',
  'aboutDialog.footerNote': 'Made with love for the community',
  'aboutDialog.attribution': 'Based on OpenChamber (MIT) by Bohdan Triapitsyn.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Orbit efficiently',
  ...
  'header.actions.openAppMenu': 'Orbit menu',
  'header.actions.openAppMenuAria': 'Open Orbit menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Orbit from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Orbit',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Orbit servers',
  ...
  'multiRun.window.description': 'Orbit Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Orbit',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Orbit does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Orbit — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Orbit settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Orbit server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Orbit server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Orbit version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Orbit but is not compatible with this app version. Update Orbit on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Orbit. Verify the address points to an Orbit server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Orbit. Verify the address points to an Orbit server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Orbit server at "{host}" is not compatible with this app version. Update Orbit on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Orbit could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Orbit...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: orbit update',
  'mobileUpdate.toast.available.title': 'Orbit update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Orbit open.',
