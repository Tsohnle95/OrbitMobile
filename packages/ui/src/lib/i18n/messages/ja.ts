...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.welcome.title': 'Orbit に接続',
  ...
  'mobile.connect.password.placeholder': 'Orbit のパスワード',
  ...
  'mobile.connect.relay.badge': 'Orbit Relay 経由',
  ...
  'mobile.connect.error.unreachable': 'その Orbit サーバーに接続できませんでした。',
  ...
  'mobile.connect.scan.invalid': 'その QR コードは Orbit の接続コードではありません。',
  ...
  'sessions.sidebar.footer.actions.aboutOrbit': 'Orbitについて',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'このアプリが接続している Orbit サーバーはウォークスルー API に応答しませんでした。つまりアプリより古いバージョンです。サーバーを 1.18 以降に更新してから再読み込みしてください。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} は Orbit が動いているマシン上にあり、そこへの接続を開けませんでした。あなたのマシンの内容はここには表示されません。',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'これらは Orbit を動かしているマシン上で動作しています。開くにはデスクトップアプリが必要です。',
  ...
  'contextPanel.browser.trustNotice': 'ここで開かれたページはOrbitへの完全なアクセス権を持ちます — 検査とスクリーンショットに必要です。信頼できるサイトのみを開いてください: 悪意のあるページがデータを読み取ったりあなたの代わりに行動したりする可能性があります。',
  ...
  'filesView.editor.binaryFileDescription': 'このファイルはバイナリのため、Orbitでは編集できません。別のアプリで開くにはダウンロードしてください。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Orbit がこのフォルダにアクセスする必要があります。',
  ...
  'aboutDialog.orbitVersionLabel': 'Orbit バージョン {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Orbitの状態、OpenCodeの状態、ディレクトリ、プロジェクトが含まれます。',
  'aboutDialog.footerNote': 'コミュニティへの愛情を込めて',
  'aboutDialog.attribution': 'OpenChamber（MIT、Bohdan Triapitsyn 作）を基盤としています。',
  ...
  'helpDialog.description': 'これらのキーボードショートカットを使ってOrbitを効率的に操作できます',
  ...
  'header.actions.openAppMenu': 'Orbitメニュー',
  'header.actions.openAppMenuAria': 'Orbitメニューを開く',
  ...
  'sessionAuth.error.networkDescription': 'UI セッションを確認できませんでした。ローカルネットワーク上の別のデバイスから Orbit を開く場合は、デスクトップアプリで Desktop Network Access を有効にし、設定に表示される LAN アドレスを使用してください。',
  ...
  'sessionAuth.locked.unlockTitle': 'Orbitのロックを解除',
  ...
  'desktopHostSwitcher.description': 'ローカルとリモートのOrbitサーバーを切り替えます',
  ...
  'multiRun.window.description': 'Orbitマルチランウィンドウ。',
  ...
  'onboarding.chooser.title': 'Orbitへようこそ',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OrbitがOpenCodeを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'OpenCodeはOrbitの中核です — インストールして開始しましょう。',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Orbit設定に保存し、OpenCode設定を再読み込みします。',
  ...
  'onboarding.remoteConnection.description': '接続するOrbitサーバーのアドレスを入力します。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'ヒント: URLがOrbitサーバーを指しているか確認するか、サーバー管理者に問い合わせてください。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'このインスタンスは異なるバージョンのOrbitを実行しています。接続は可能ですが、正常に動作しない場合は両方のアプリを更新してください。',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'サーバーはOrbitを実行していますが、このアプリバージョンと互換性がありません。サーバーのOrbitを更新してから再試行してください。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'サーバーは応答しましたが、Orbitを実行していません。アドレスがOrbitサーバーを指していることを確認してください。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」のサーバーはOrbitを実行していません。アドレスがOrbitサーバーを指していることを確認してください。',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'サーバーの更新が必要',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」のOrbitサーバーはこのアプリバージョンと互換性がありません。サーバーのOrbitを更新してから再試行してください。',
  ...
  'startup.initRecovery.description': 'Orbitが初期化を完了できませんでした。サーバーが実行中であることを確認してから再試行してください。',
  ...
  'updateDialog.header.updating': 'Orbitを更新中...',
  ...
  'updateDialog.error.takingLonger': '更新に予想以上に時間がかかっています。しばらく待ってから更新するか、次を実行: orbit update',
  'mobileUpdate.toast.available.title': 'Orbitの更新があります',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Orbitを開いたままにしてください。',
