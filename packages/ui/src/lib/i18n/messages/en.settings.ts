...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. Orbit never scans browser cookie storage.',
  ...
  'settings.window.description': 'Orbit settings window.',
  ...
  'settings.page.appearance.description': 'Customize how Orbit looks and feels.',
  ...
  'settings.orbit.tunnel.title': 'External Tunnel',
  'settings.orbit.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.orbit.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.orbit.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.orbit.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.orbit.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.orbit.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.orbit.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.orbit.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.orbit.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.orbit.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.orbit.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.orbit.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.orbit.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.orbit.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.orbit.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.orbit.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.orbit.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.orbit.tunnel.field.provider': 'Provider',
  'settings.orbit.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.orbit.tunnel.field.tunnelType': 'Tunnel type',
  'settings.orbit.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.orbit.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.orbit.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.orbit.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.orbit.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.orbit.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.orbit.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.orbit.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.orbit.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.orbit.tunnel.field.configurationFile': 'Configuration file',
  'settings.orbit.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.orbit.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.orbit.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.orbit.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.orbit.tunnel.field.connectLink': 'Connect link',
  'settings.orbit.tunnel.field.expires': 'Expires',
  'settings.orbit.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.orbit.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.orbit.tunnel.actions.saveToken': 'Save token',
  'settings.orbit.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.orbit.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.orbit.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.orbit.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.orbit.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.orbit.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.orbit.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.orbit.tunnel.actions.stopping': 'Stopping...',
  'settings.orbit.tunnel.actions.newConnectLink': 'New connect link',
  'settings.orbit.tunnel.actions.copied': 'Copied',
  'settings.orbit.tunnel.actions.retry': 'Retry',
  'settings.orbit.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.orbit.tunnel.option.mode.quick.label': 'Quick',
  'settings.orbit.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.orbit.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.orbit.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.orbit.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.orbit.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.orbit.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.orbit.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  'settings.orbit.tunnel.badge.quick': 'QUICK',
  'settings.orbit.tunnel.badge.remote': 'REMOTE',
  'settings.orbit.tunnel.badge.local': 'LOCAL',
  'settings.orbit.tunnel.state.loading': 'Loading',
  'settings.orbit.tunnel.state.expired': 'Expired',
  'settings.orbit.tunnel.state.revoked': 'Revoked',
  'settings.orbit.tunnel.state.inactive': 'Inactive',
  'settings.orbit.tunnel.state.noExpiry': 'No expiry',
  'settings.orbit.tunnel.state.never': 'Never',
  'settings.orbit.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.orbit.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.orbit.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.orbit.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.orbit.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.orbit.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/orbit/cloudflare-managed-remote-tunnels.json.',
  'settings.orbit.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.orbit.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.orbit.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.orbit.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.orbit.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.orbit.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.orbit.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.orbit.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.orbit.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.orbit.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.orbit.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.orbit.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.orbit.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.orbit.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.orbit.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.orbit.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.orbit.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.orbit.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.orbit.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.orbit.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.orbit.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.orbit.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.orbit.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.orbit.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.orbit.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.orbit.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other Orbit servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another Orbit server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Orbit server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Orbit connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Orbit Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the Orbit app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through Orbit Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the Orbit app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Orbit should start the server for you, or connect to one that is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port Orbit uses on the remote machine. Leave empty to choose one automatically.',
  ...
  'settings.orbit.appLinks.title': 'Trusted app links',
  'settings.orbit.appLinks.info': 'Links listed here open without asking again on this device. Other app links always ask before opening.',
  'settings.orbit.appLinks.empty': 'No trusted app links on this device. Choose "Trust and open" when opening a link to add it here.',
  'settings.orbit.appLinks.removeAria': 'Remove trusted {scheme} links',
  ...
  'settings.orbit.about.title': 'About Orbit',
  'settings.orbit.about.field.version': 'Version',
  'settings.orbit.about.field.openCodeVersion': 'OpenCode version',
  'settings.orbit.about.field.instanceUrls': 'Instance URLs',
  'settings.orbit.about.field.applicationUrl': 'Application',
  'settings.orbit.about.field.tunnelUrl': 'Tunnel',
  'settings.orbit.about.state.checking': 'Checking...',
  'settings.orbit.about.state.upToDate': 'Up to date',
  'settings.orbit.about.state.unknown': 'unknown',
  'settings.orbit.about.actions.checkUpdates': 'Check updates',
  'settings.orbit.about.actions.update': 'Update',
  'settings.orbit.about.actions.updateToVersion': 'Update to {version}',
  'settings.orbit.about.actions.checkForUpdates': 'Check for updates',
  'settings.orbit.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Orbit will scan it for folders containing',
  ...
  'settings.orbit.passkeys.field.currentDevice': 'Current device',
  'settings.orbit.passkeys.actions.add': 'Add passkey',
  'settings.orbit.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.orbit.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.orbit.passkeys.actions.signingOut': 'Signing out…',
  'settings.orbit.passkeys.actions.removing': 'Removing…',
  'settings.orbit.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.orbit.passkeys.state.loading': 'Loading passkeys…',
  'settings.orbit.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.orbit.passkeys.item.lastUsed': 'Last used {time}',
  'settings.orbit.passkeys.item.added': 'Added {time}',
  'settings.orbit.passkeys.time.neverUsed': 'Never used',
  'settings.orbit.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.orbit.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.orbit.passkeys.toast.added': 'Passkey added',
  'settings.orbit.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.orbit.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.orbit.passkeys.toast.removed': 'Passkey removed',
  'settings.orbit.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.orbit.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.orbit.sessionRetention.title': 'Session Retention',
  'settings.orbit.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.orbit.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.orbit.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.orbit.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.orbit.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.orbit.sessionRetention.field.days': 'days',
  'settings.orbit.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.orbit.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.orbit.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.orbit.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.orbit.sessionRetention.action.archive': 'Archive',
  'settings.orbit.sessionRetention.action.delete': 'Delete',
  'settings.orbit.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.orbit.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.orbit.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.orbit.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.orbit.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.orbit.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.orbit.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.orbit.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.orbit.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.orbit.desktopNetwork.title': 'Desktop Network Access',
  'settings.orbit.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.orbit.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Defaults to the right.',
  'settings.orbit.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.orbit.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.orbit.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.orbit.desktopNetwork.field.windowControls': 'Window controls',
  'settings.orbit.desktopNetwork.field.windowControlsStyle': 'Style',
  'settings.orbit.desktopNetwork.field.windowControlsStyleAria': 'Window controls style',
  'settings.orbit.desktopNetwork.option.windowControlsClassic': 'Classic',
  'settings.orbit.desktopNetwork.option.windowControlsTrafficLights': 'Traffic lights',
  'settings.orbit.desktopNetwork.field.launchAtLoginAria': 'Start Orbit at login',
  'settings.orbit.desktopNetwork.field.launchAtLogin': 'Start Orbit when you log in',
  'settings.orbit.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.orbit.desktopNetwork.field.macMenuBarAria': 'Show Orbit in the macOS menu bar',
  'settings.orbit.desktopNetwork.field.macMenuBar': 'Show Orbit in the menu bar',
  'settings.orbit.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, Orbit does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.orbit.desktopNetwork.field.minimizeToTrayAria': 'Close Orbit to the system tray',
  'settings.orbit.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.orbit.desktopNetwork.field.minimizeToTrayDescription': 'Keeps Orbit running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.orbit.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Orbit is running',
  'settings.orbit.desktopNetwork.field.keepAwake': 'Keep computer awake while Orbit is running',
  'settings.orbit.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.orbit.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.orbit.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.orbit.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.orbit.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.orbit.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.orbit.desktopPassword.actions.showPassword': 'Show password',
  'settings.orbit.desktopPassword.actions.hidePassword': 'Hide password',
  'settings.orbit.desktopPassword.field.password': 'Desktop UI Password',
  'settings.orbit.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.orbit.desktopPassword.field.passwordDescription': 'Orbit asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.orbit.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.orbit.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.orbit.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.orbit.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.orbit.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.orbit.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.orbit.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.orbit.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.orbit.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.orbit.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.orbit.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.orbit.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.orbit.opencodeCli.title': 'OpenCode CLI',
  'settings.orbit.tools.title': 'Orbit Tools',
  'settings.orbit.tools.field.agentControlTool': 'Agent control tool',
  'settings.orbit.tools.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.orbit.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.orbit.tools.field.agentWebTool': 'Orbit Web tool',
  'settings.orbit.tools.field.agentWebToolAria': 'Enable the Orbit Web tool',
  'settings.orbit.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in Orbit\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.orbit.tools.field.agentMemoryTool': 'Agent memory tool',
  'settings.orbit.tools.field.agentMemoryToolAria': 'Agent memory tool',
  'settings.orbit.tools.field.agentMemoryToolInfo': 'Let agents keep what they learn across sessions, in two stores: what is true about you, and what is true about each project. Sessions are given the stored titles so the agent can read an entry when it is relevant. Turning this off removes the tool, the Memory tab, and the session index. Applies after OpenCode restarts.',
  'settings.orbit.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.orbit.opencodeCli.tooltipSuffix': 'binary.',
  'settings.orbit.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.orbit.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.orbit.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.orbit.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.orbit.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.orbit.opencodeCli.actions.browse': 'Browse',
  'settings.orbit.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.orbit.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.orbit.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.orbit.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.orbit.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.orbit.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.orbit.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.orbit.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.orbit.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.orbit.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.orbit.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.orbit.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.orbit.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.orbit.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.orbit.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.orbit.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.orbit.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.orbit.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.orbit.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.orbit.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.orbit.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.orbit.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle context panel',
  'settings.orbit.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open Git surface',
  'settings.orbit.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open Files surface',
  'settings.orbit.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.orbit.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.orbit.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.orbit.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.orbit.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.orbit.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.orbit.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.orbit.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.orbit.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.orbit.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.orbit.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.orbit.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.orbit.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.orbit.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.orbit.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.orbit.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.orbit.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Orbit there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Orbit on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Orbit should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Access from this computer',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Orbit runs on the remote machine. These settings only control the address on this computer that forwards to it through the SSH tunnel.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Orbit UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Orbit should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Set a remote port first. In "Already running" mode Orbit needs to know which port the server listens on.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Also let other devices on the remote machine’s network open this Orbit directly, without the SSH tunnel. A UI password is required.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Anyone on that network can reach the remote Orbit. It is protected only by the UI password below.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Set a UI password first. Publishing the remote Orbit to its network without one would leave it open to every device there.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Password to protect the remote Orbit UI. Orbit sets it on the server it starts for you.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Password of the Orbit server already running on the remote machine, used to sign in to it.',
  ...
  'settings.remoteInstances.page.phase.installingOrbit': 'Installing Orbit',
  'settings.remoteInstances.page.phase.updatingOrbit': 'Updating Orbit',
  ...
  'settings.orbit.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.orbit.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.orbit.worktrees.setup.title': 'Setup commands',
  'settings.orbit.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.orbit.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.orbit.worktrees.setup.loading': 'Loading...',
  'settings.orbit.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.orbit.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.orbit.worktrees.setup.addCommand': 'Add command',
  'settings.orbit.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.orbit.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.orbit.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.orbit.worktrees.list.title': 'Existing worktrees',
  'settings.orbit.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.orbit.worktrees.list.loading': 'Loading worktrees...',
  'settings.orbit.worktrees.list.empty': 'No worktrees found for this project',
  'settings.orbit.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.orbit.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by Orbit. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Orbit.',
  ...
  'settings.orbit.defaults.title': 'Session Defaults',
  'settings.orbit.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.orbit.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.orbit.defaults.field.defaultModel': 'Default Model',
  'settings.orbit.defaults.field.defaultThinking': 'Default Thinking',
  'settings.orbit.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.orbit.defaults.field.defaultAgent': 'Default Agent',
  'settings.orbit.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.orbit.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.orbit.defaults.smallModel.title': 'Small Model',
  'settings.orbit.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.orbit.defaults.smallModel.useDefault': 'Use default small model',
  'settings.orbit.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.orbit.defaults.smallModel.overrideModel': 'Override model',
  'settings.orbit.defaults.walkthroughModel.title': 'Changes Walkthrough Model',
  ...
  'settings.orbit.defaults.walkthroughModel.overrideModel': 'Walkthrough model',
  'settings.orbit.defaults.walkthroughModel.usesSmallModel': 'Small model',
  'settings.orbit.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.orbit.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.orbit.defaults.option.default': 'Default',
  'settings.orbit.defaults.option.defaultLowercase': 'default',
  'settings.orbit.git.title': 'Git Preferences',
  'settings.orbit.git.changesViewTitle': 'Changes View',
  'settings.orbit.git.changesViewAria': 'Git changes view mode',
  'settings.orbit.git.option.flatList': 'Flat List',
  'settings.orbit.git.option.treeView': 'Tree View',
  'settings.orbit.git.optionAria': 'Git changes view mode: {option}',
  'settings.orbit.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.orbit.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.orbit.git.showGitignoredAria': 'Display gitignored files',
  'settings.orbit.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize Orbit',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Orbit auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Orbit.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the Orbit server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the Orbit server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  'settings.orbit.visual.section.colorMode': 'Color Mode',
  'settings.orbit.visual.section.colorModeAndTheme': 'Color mode & Theme',
  'settings.orbit.visual.section.localization': 'Localization',
  'settings.orbit.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.orbit.visual.section.densityAndType': 'Density & type',
  'settings.orbit.visual.section.appInstall': 'App install',
  'settings.orbit.visual.section.navigation': 'Navigation',
  'settings.orbit.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.orbit.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.orbit.visual.section.chatDisplay': 'Display',
  'settings.orbit.visual.section.chatMessageOptions': 'Message options',
  'settings.orbit.visual.section.chatFeatures': 'Features',
  'settings.orbit.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.orbit.visual.section.activityDefault': 'Activity Default',
  'settings.orbit.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.orbit.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.orbit.visual.section.sessionAssistance': 'Session Assistance',
  'settings.orbit.visual.section.reasoning': 'Reasoning',
  'settings.orbit.visual.section.messageAppearance': 'Message Appearance',
  'settings.orbit.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.orbit.visual.section.composer': 'Composer',
  'settings.orbit.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.orbit.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.orbit.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.orbit.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.orbit.visual.section.diffLayout': 'Diff Layout',
  'settings.orbit.visual.section.diffLayoutAria': 'Diff layout',
  'settings.orbit.visual.section.privacy': 'Privacy',
  'settings.orbit.visual.field.lightTheme': 'Light Theme',
  'settings.orbit.visual.field.darkTheme': 'Dark Theme',
  'settings.orbit.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.orbit.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.orbit.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.orbit.visual.field.timeFormat': 'Time Format',
  'settings.orbit.visual.field.weekStartsOn': 'Week Starts On',
  'settings.orbit.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.orbit.visual.field.selectWeekStartAria': 'Select week start',
  'settings.orbit.visual.actions.reloadThemes': 'Reload themes',
  'settings.orbit.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.orbit.visual.field.dockBadge': 'Dock badge',
  'settings.orbit.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.orbit.visual.actions.saveAndRestart': 'Save & restart',
  'settings.orbit.visual.actions.restarting': 'Restarting…',
  'settings.orbit.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.orbit.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/orbit/themes/',
  'settings.orbit.visual.field.installAppName': 'Install App Name',
  'settings.orbit.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.orbit.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.orbit.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.orbit.visual.field.installOrientation': 'Install Orientation',
  'settings.orbit.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.orbit.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.orbit.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.orbit.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.orbit.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.orbit.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.orbit.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.orbit.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.orbit.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.orbit.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.orbit.visual.field.interfaceFont': 'Interface Font',
  'settings.orbit.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.orbit.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.orbit.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.orbit.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.orbit.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.orbit.visual.field.terminalShell': 'Terminal Shell',
  'settings.orbit.visual.field.terminalShellAria': 'Select terminal shell',
  'settings.orbit.visual.field.terminalShellHint': 'Restart the terminal to apply this change to the current session.',
  'settings.orbit.visual.field.terminalLoginShell': 'Start as login shell',
  'settings.orbit.visual.option.terminalShell.auto': 'Auto',
  'settings.orbit.visual.field.editorFontSize': 'Editor Font Size',
  'settings.orbit.visual.field.codeFont': 'Code Font',
  'settings.orbit.visual.field.selectCodeFontAria': 'Select code font',
  'settings.orbit.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.orbit.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.orbit.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.orbit.visual.field.spacingDensity': 'Spacing Density',
  'settings.orbit.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.orbit.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.orbit.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.orbit.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.orbit.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.orbit.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.orbit.visual.field.sessionTabsGroup': 'Session tabs',
  'settings.orbit.visual.field.sessionTabs': 'Show sessions as tabs in the header',
  'settings.orbit.visual.field.sessionTabsAria': 'Toggle session tabs in the header',
  'settings.orbit.visual.field.sessionTabsInfo': 'Sessions you open line up as tabs in the header. Turning this off restores the plain session title.',
  'settings.orbit.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.orbit.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.orbit.visual.option.fileEditorKeymap.default': 'Default',
  'settings.orbit.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.orbit.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.orbit.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.orbit.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.orbit.visual.field.bash': 'Bash',
  'settings.orbit.visual.field.editTools': 'Edit tools',
  'settings.orbit.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  ...
  'settings.orbit.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.orbit.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.orbit.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.orbit.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.orbit.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.orbit.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.orbit.visual.goal.sectionTitle': 'Goal',
  'settings.orbit.visual.goal.budgetLabel': 'Default token budget',
  'settings.orbit.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.orbit.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.orbit.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.orbit.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.orbit.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.orbit.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.orbit.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.orbit.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.orbit.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.orbit.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.orbit.visual.field.autoSaveEnabledAria': 'Auto-save files',
  'settings.orbit.visual.field.autoSaveEnabled': 'Auto-save files',
  'settings.orbit.visual.field.autoSaveEnabledInfo': 'Automatically save file edits after you stop typing. Disable to require manual save.',
  'settings.orbit.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.orbit.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.orbit.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.orbit.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.orbit.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.orbit.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.orbit.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.orbit.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.orbit.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.orbit.visual.field.draftStartersVisible': 'Show Starters on New Session Screen',
  'settings.orbit.visual.field.draftStartersVisibleAria': 'Show starters on the new session screen',
  'settings.orbit.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.orbit.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.orbit.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.orbit.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.orbit.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.orbit.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.orbit.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.orbit.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.orbit.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.orbit.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.orbit.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.orbit.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.orbit.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.orbit.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.orbit.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.orbit.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.orbit.visual.option.themeMode.system': 'System',
  'settings.orbit.visual.option.themeMode.system.description': 'Follow system setting',
  'settings.orbit.visual.option.themeMode.light': 'Light',
  'settings.orbit.visual.option.themeMode.light.description': 'Always use light appearance',
  'settings.orbit.visual.option.themeMode.dark': 'Dark',
  'settings.orbit.visual.option.themeMode.dark.description': 'Always use dark appearance',
  'settings.orbit.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.orbit.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.orbit.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.orbit.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.orbit.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.orbit.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.orbit.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.orbit.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.orbit.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.orbit.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.orbit.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.orbit.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.orbit.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.orbit.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.orbit.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.orbit.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.orbit.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.orbit.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.orbit.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.orbit.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.orbit.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.orbit.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.orbit.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.orbit.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.orbit.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.orbit.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.orbit.visual.option.chatRenderMode.live.label': 'Live',
  'settings.orbit.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.orbit.visual.option.messageTransport.auto.label': 'Auto',
  'settings.orbit.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.orbit.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.orbit.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.orbit.visual.option.messageTransport.sse.label': 'SSE',
  'settings.orbit.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.orbit.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.orbit.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.orbit.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.orbit.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.orbit.visual.option.timeFormat.auto.label': 'Auto',
  'settings.orbit.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.orbit.visual.option.timeFormat.24h.label': '24-hour',
  'settings.orbit.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.orbit.visual.option.timeFormat.12h.label': '12-hour',
  'settings.orbit.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.orbit.visual.option.weekStart.auto.label': 'Auto',
  'settings.orbit.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.orbit.visual.option.weekStart.monday.label': 'Monday',
  'settings.orbit.visual.option.weekStart.sunday.label': 'Sunday',
