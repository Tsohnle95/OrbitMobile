...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.weekStartsOn',
    keywords: ['calendar', 'monday', 'sunday'],
  },
  {
    id: 'appearance.light-theme',
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.dockBadge',
    descriptionKey: 'settings.orbit.visual.field.dockBadgeHint',
    keywords: ['dock', 'badge', 'unread', 'unseen', 'counter', 'count', 'notification', 'macos'],
    // Exactly matches the render guard in OrbitVisualSettings: any darwin
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.installAppName',
    descriptionKey: 'settings.orbit.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.installOrientation',
    descriptionKey: 'settings.orbit.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.orbit.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.terminal-shell',
    page: 'general',
    titleKey: 'settings.orbit.visual.field.terminalShell',
    descriptionKey: 'settings.orbit.visual.field.terminalShellHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.orbit.visual.field.inputBarOffset',
    descriptionKey: 'settings.orbit.visual.field.inputBarOffsetTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.visual.field.autoSaveEnabled',
    descriptionKey: 'settings.orbit.visual.field.autoSaveEnabledInfo',
    keywords: ['editor', 'autosave', 'auto-save', 'files', 'save'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'general',
    titleKey: 'settings.orbit.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.session-tabs',
    page: 'general',
    titleKey: 'settings.orbit.visual.field.sessionTabsGroup',
    descriptionKey: 'settings.orbit.visual.field.sessionTabsInfo',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.orbit.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.orbit.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'general.app-links',
    page: 'general',
    titleKey: 'settings.orbit.appLinks.title',
    descriptionKey: 'settings.orbit.appLinks.info',
    keywords: ['security', 'app link', 'deep link', 'scheme', 'protocol', 'obsidian', 'notion'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.orbit.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'general',
    titleKey: 'settings.orbit.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.session-recap',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.sessionRecap',
    keywords: ['recap', 'assist', 'small model', 'summary'],
  },
  {
    id: 'chat.session-assistance',
    page: 'chat',
    titleKey: 'settings.orbit.visual.section.sessionAssistance',
    keywords: ['recap', 'suggestion', 'subagent'],
  },
  {
    id: 'chat.session-suggestion',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.sessionSuggestion',
    keywords: ['suggestion', 'assist', 'small model', 'follow up'],
  },
  {
    id: 'chat.session-goal',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.sessionGoal',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.orbit.visual.goal.budgetLabel',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.orbit.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.prompt-navigator',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.promptNavigatorEnabled',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.orbit.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.orbit.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.draft-starters-visible',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.draftStartersVisible',
    keywords: ['starter', 'starters', 'new session', 'welcome', 'suggestions'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.orbit.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.orbit.visual.section.followUpBehavior',
    descriptionKey: 'settings.orbit.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.orbit.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.orbit.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.orbit.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.orbit.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.orbit.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.orbit.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.orbit.defaults.smallModel.title',
    descriptionKey: 'settings.orbit.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.walkthrough-model',
    page: 'sessions',
    titleKey: 'settings.orbit.defaults.walkthroughModel.title',
    descriptionKey: 'settings.orbit.defaults.walkthroughModel.description',
    keywords: ['walkthrough', 'diff', 'review', 'changes', 'structured output', 'model', 'override'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.orbit.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.orbit.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.orbit.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.orbit.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'general',
    titleKey: 'settings.orbit.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.orbit.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.orbit.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.orbit.desktopNetwork.field.windowControlsStyle',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.desktopNetwork.field.macMenuBar',
    descriptionKey: 'settings.orbit.desktopNetwork.field.macMenuBarDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.orbit.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.orbit.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.desktopPassword.field.password',
    descriptionKey: 'settings.orbit.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.orbit.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.orbit.tools.field.agentControlTool',
    descriptionKey: 'settings.orbit.tools.field.agentControlToolInfo',
    keywords: ['agent', 'tool', 'orchestration', 'orbit', 'sessions', 'schedule', 'control'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-web-tool',
    page: 'general',
    titleKey: 'settings.orbit.tools.field.agentWebTool',
    descriptionKey: 'settings.orbit.tools.field.agentWebToolInfo',
    keywords: ['agent', 'tool', 'web', 'browser', 'page', 'preview', 'orbit'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-memory-tool',
    page: 'general',
    titleKey: 'settings.orbit.tools.field.agentMemoryTool',
    descriptionKey: 'settings.orbit.tools.field.agentMemoryToolInfo',
    keywords: ['agent', 'tool', 'memory', 'remember', 'recall', 'preferences', 'orbit'],
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.orbit.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.orbit.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.orbit.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.orbit.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.orbit.keyboardShortcuts.title',
    descriptionKey: 'settings.orbit.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.orbit.tunnel.field.provider',
    descriptionKey: 'settings.orbit.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.orbit.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.orbit.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.orbit.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.orbit.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.orbit.tunnel.field.configurationFile',
    descriptionKey: 'settings.orbit.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.orbit.tunnel.actions.startTunnel',
    descriptionKey: 'settings.orbit.tunnel.note.connectLinksOneTime',
  ...
  },
  {
    ...
    keywords: ['claude', 'anthropic', 'claude code', 'pro', 'max', 'agent sdk', '@orbit/opencode-claude'],
  },
  {
    ...
    keywords: ['cursor', 'oauth', 'subscription', 'openai compatible', '@orbit/opencode-cursor'],
  },
] as const;
