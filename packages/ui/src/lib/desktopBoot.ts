 ...
 * it as `window.__ORBIT_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __ORBIT_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__ORBIT_DESKTOP_BOOT_OUTCOME__;
