...
const detectHostedSurface = (): HostedSurface => {
  ...
  const explicitSurface = window.__ORBIT_SURFACE__;
...
export const resolveHostedSurface = (): HostedSurface => {
  ...
  if (typeof window !== 'undefined') {
    window.__ORBIT_SURFACE__ = surface;
  }
  return surface;
};
