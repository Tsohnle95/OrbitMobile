...
describe('checkForUpdates', () => {
  ...
  it('resolves an Android APK asset when the update API returns an AAB', async () => {
    fetchMock
      .when('api.openchamber.dev', {
        ...
        json: async () => ({
          latestVersion: '1.10.0',
          updateAvailable: true,
          downloadUrl: 'https://github.com/openchamber/orbit/releases/download/v1.10.0/Orbit-1.10.0-42-android.aab',
        }),
      })
      .when('api.github.com/repos/orbit/orbit/releases/tags/v1.10.0', {
        ok: true,
        json: async () => ({
          assets: [
            {
              name: 'Orbit-1.10.0-42-android.aab',
              browser_download_url: 'https://downloads.example/Orbit-1.10.0-42-android.aab',
            },
            {
            ...
            {
              name: 'Orbit-1.10.0-42-android.apk',
              browser_download_url: 'https://downloads.example/Orbit-1.10.0-42-android.apk',
            },
          ],
        }),
      });
    ...
    expect(result.downloadUrl).toBe('https://downloads.example/Orbit-1.10.0-42-android.apk');
  });

  it('keeps a direct Android APK URL from the update API', async () => {
    const apkUrl = 'https://github.com/openchamber/orbit/releases/download/v1.10.0/Orbit-1.10.0-42-android.apk';
