...
import { registerOrbitSessionRoutes } from '../orbit-sessions/routes.js';
import { registerOrbitControlRoutes } from '../orbit-control/routes.js';
...
export const createFeatureRoutesRuntime = (dependencies) => {
  ...
  const registerRoutes = async (app, routeDependencies) => {
    ...
    registerOrbitControlRoutes(app, { controlService: orbitControlService });
