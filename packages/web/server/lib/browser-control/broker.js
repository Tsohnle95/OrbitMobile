 ...
 * on a page directly. It publishes a request over the existing Orbit
    ...
    request(action, parameters = {}, { timeoutMs = DEFAULT_TIMEOUT_MS, signal } = {}) {
      ...
      if (!listenerCount) {
        ...
        return Promise.reject(new BrowserControlError(
          'No Orbit client connected here can control a page. Reading and '
          + 'interacting with a page works when Orbit runs as its desktop '
