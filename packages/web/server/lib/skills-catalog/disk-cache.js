...
const resolveDataDir = () => (process.env.ORBIT_DATA_DIR
...
/**
 * Read a persisted cache object from the Orbit data directory.
...
/**
 * Persist a cache object to the Orbit data directory with an atomic
