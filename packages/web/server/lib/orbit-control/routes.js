...
export const registerOrbitControlRoutes = (app, { controlService }) => {
  app.post('/api/orbit/control', express.json({ limit: '1mb' }), async (req, res) => {
    ...
    try {
      ...
      const controlError = asControlError(error, 'Orbit control action failed');
