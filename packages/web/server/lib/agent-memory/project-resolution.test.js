...
const PROJECT = '/Users/x/projects/orbit';
...
describe('resolving a session directory to its project', () => {
  ...
  test('managed chat session directories share the Chats root store', async () => {
    const chatsRoot = '/Users/x/.config/orbit/chats';
    ...
    expect(await resolve('/Users/x/.config/orbit/chats-other/session-a')).not.toBe(createProjectIdFromPath(chatsRoot));
  });
