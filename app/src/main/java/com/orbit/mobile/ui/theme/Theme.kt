package com.orbit.mobile.ui.theme
...
val LocalOrbitColors = staticCompositionLocalOf { PaperColors }
...
fun OrbitTheme(
    ...
    androidx.compose.runtime.CompositionLocalProvider(LocalOrbitColors provides omni) {
        MaterialTheme(
            colorScheme = scheme,
